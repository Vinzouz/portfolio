...
export const CardBody = ({
  ...
  return (
    <div
      className={cn(
        "min-h-[550px] w-90 sm:w-96 [transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d]",
        className
      )}>
      {children}
    </div>
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      <CardContainer containerClassName="py-0">
        <CardBody
          className="relative h-auto w-auto rounded-xl border bg-card p-6 shadow-xl">
